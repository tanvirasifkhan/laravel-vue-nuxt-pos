            ...
            <div class="bg-white border border-gray-100 rounded-lg mt-7">
                <div class="border-b border-gray-200 flex items-center justify-between py-3 px-5">
                    ...
                    <div class="w-6/12 flex justify-end space-x-1.5">
                        <input type="date" placeholder="Search Purchase Order" class="border border-gray-200 font-roboto text-gray-500 rounded-2xl py-2 px-4 outline-none focus:outline-none">
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="py-3 px-5 text-gray-600 font-roboto">324568968/</td>
                            <td class="py-3 px-5 text-gray-600 font-roboto">200</td>
                            <td class="py-3 px-5 text-gray-600 font-roboto space-x-2">
                                <button class="bg-indigo-500 hover:bg-indigo-700 text-white font-roboto py-1.5 px-4 rounded-3xl">View Details</button>
