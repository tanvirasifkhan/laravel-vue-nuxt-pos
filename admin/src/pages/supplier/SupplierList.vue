        ...
        <div class="w-8/12 mx-auto">            
            <div class="bg-white border border-gray-100 rounded-lg mt-7">
                <div class="border-b border-gray-200 flex items-center justify-between py-3 px-5">
                    ...
                    <div class="w-6/12 flex justify-end space-x-1.5">
                        <input type="text" placeholder="Search Supplier" class="border border-gray-200 font-roboto text-gray-500 rounded-2xl py-2 px-4 outline-none focus:outline-none">
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        <tr>
                            <td class="py-3 px-5 text-gray-600 font-roboto">Name</td>
                            <td class="py-3 px-5 text-gray-600 font-roboto">Email address</td>
                            <td class="py-3 px-5 text-gray-600 font-roboto">Phone</td>
                            <td class="py-3 px-5 text-gray-600 font-roboto">Address</td>
                            <td class="py-3 px-5 text-gray-600 font-roboto space-x-2">
                                <button class="bg-indigo-500 hover:bg-indigo-700 text-white font-roboto py-1.5 px-4 rounded-3xl">Edit</button>
